"""Trains a ResNet on the flowers dataset.
ResNet v1
...
"""
#CUDA_VISIBLE_DEVICES="0" python3 resnet_keras.py

from __future__ import print_function
import keras
from tensotflow,keras.layers import Dense, Conv2D, BatchNormalization, Activation
...
x_train,y_train,x_test,y_test=load_data(data_dir='./17flowers/jpg/')
